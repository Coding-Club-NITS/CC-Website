        ...
        <BackgroundBeamsWithCollision>
          ...
          <div className="absolute top-40 left-1/2 transform -translate-x-1/2 mt-8 px-6 text-center max-w-4xl">
            <p className="text-white text-lg leading-relaxed font-medium opacity-90">
              ...
              mission is to empower aspiring developers and problem solvers with
              the knowledge, skills, and confidence needed to excel in their
              coding journeys.
            </p>
            <p className="text-white text-lg leading-relaxed font-medium opacity-90 mt-4">
              We mentor students through hands-on sessions, workshops, and
              projects, covering essential topics such as data structures,
              algorithms, and cutting-edge technologies. Our comprehensive
              training prepares members for upcoming interviews, coding
              assessments, and competitive programming challenges.
            </p>
            <p className="text-white text-lg leading-relaxed font-medium opacity-90 mt-4">
              Join us, and let’s shape the future together, one line of code at
              a time!
            </p>
