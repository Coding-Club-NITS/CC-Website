...
export const LensDemo: React.FC<LensDemoProps> = ({ url }) => {
  ...
  return (
    <div>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto p-8 my-10">
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#FFEB3B" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#FFEB00" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#FFEB3B" />
      </g>
      <defs>
        <filter
